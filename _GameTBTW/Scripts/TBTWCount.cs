...
/// </summary>
public class TBTWCount : MonoBehaviour
{
	private static TBTWCount _instance;

	public static TBTWCount Instance {
		get{
			if(_instance == null) {
				_instance = (TBTWCount) FindObjectOfType(typeof(TBTWCount));
			}
			return _instance;
		}
	}
...
//					NGUITools.PlaySound(soundCount);
	...
	public void UpdateHUD(int num) {
		...
		spriteL.spriteName = "" + numStr.Substring (0, 1);
		spriteR.spriteName = "" + numStr.Substring (1, 1);
	}
