...
public class NGUIToolsWrap
{
	...
	{
		LuaScriptMgr.Push(L, NGUITools.screenSize);
		return 1;
	}
	...
	static int UpdateWidgetCollider(IntPtr L)
	{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(BoxCollider2D), typeof(bool)))
		{
			BoxCollider2D arg0 = (BoxCollider2D)LuaScriptMgr.GetLuaObject(L, 1);
			bool arg1 = LuaDLL.lua_toboolean(L, 2);
			NGUITools.UpdateWidgetCollider(arg0,arg1);
			return 0;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(BoxCollider), typeof(bool)))
		{
			BoxCollider arg0 = (BoxCollider)LuaScriptMgr.GetLuaObject(L, 1);
			bool arg1 = LuaDLL.lua_toboolean(L, 2);
			NGUITools.UpdateWidgetCollider(arg0,arg1);
			return 0;
		}
	...
	static int NormalizeWidgetDepths(IntPtr L)
	{
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(UIWidget[])))
		{
