...
public class UIInputWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("onReturnKey", get_onReturnKey, set_onReturnKey),
			new LuaField("keyboardType", get_keyboardType, set_keyboardType),
			new LuaField("hideInput", get_hideInput, set_hideInput),
			new LuaField("selectAllTextOnFocus", get_selectAllTextOnFocus, set_selectAllTextOnFocus),
			...
			new LuaField("inputShouldBeHidden", get_inputShouldBeHidden, null),
	...
	static int get_onReturnKey(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name onReturnKey");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index onReturnKey on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.onReturnKey);
		return 1;
	}
	...
	static int get_hideInput(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name hideInput");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index hideInput on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.hideInput);
		return 1;
	}
	...
	static int get_selectAllTextOnFocus(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name selectAllTextOnFocus");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index selectAllTextOnFocus on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.selectAllTextOnFocus);
		return 1;
	}
	...
	static int get_inputShouldBeHidden(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name inputShouldBeHidden");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index inputShouldBeHidden on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.inputShouldBeHidden);
		return 1;
	}
	...
	static int set_onReturnKey(IntPtr L)
	{
		...
		obj.onReturnKey = (UIInput.OnReturnKey)LuaScriptMgr.GetNetObject(L, 3, typeof(UIInput.OnReturnKey));
		return 0;
	}
	...
	static int set_hideInput(IntPtr L)
	{
		...
		obj.hideInput = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	static int set_selectAllTextOnFocus(IntPtr L)
	{
		...
		obj.selectAllTextOnFocus = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
