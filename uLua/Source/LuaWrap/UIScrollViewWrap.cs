...
public class UIScrollViewWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("InvalidateBounds", InvalidateBounds),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("NeedbackPosition", get_NeedbackPosition, set_NeedbackPosition),
			...
			new LuaField("dampenStrength", get_dampenStrength, set_dampenStrength),
			...
			new LuaField("onDragStarted", get_onDragStarted, set_onDragStarted),
			new LuaField("onDragFinished", get_onDragFinished, set_onDragFinished),
			new LuaField("onMomentumMove", get_onMomentumMove, set_onMomentumMove),
			new LuaField("onStoppedMoving", get_onStoppedMoving, set_onStoppedMoving),
			new LuaField("centerOnChild", get_centerOnChild, set_centerOnChild),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_NeedbackPosition(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "unknown member name NeedbackPosition");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index NeedbackPosition on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.NeedbackPosition);
		return 1;
	}
	...
	static int get_dampenStrength(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name dampenStrength");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index dampenStrength on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.dampenStrength);
		return 1;
	}
	...
	static int get_onDragStarted(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name onDragStarted");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index onDragStarted on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.onDragStarted);
		return 1;
	}
	...
	static int get_onMomentumMove(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name onMomentumMove");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index onMomentumMove on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.onMomentumMove);
		return 1;
	}
	...
	static int get_onStoppedMoving(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name onStoppedMoving");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index onStoppedMoving on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.onStoppedMoving);
		return 1;
	}
	...
	static int get_centerOnChild(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name centerOnChild");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index centerOnChild on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.centerOnChild);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_NeedbackPosition(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIScrollView obj = (UIScrollView)o;
		...
		obj.NeedbackPosition = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	static int set_dampenStrength(IntPtr L)
	{
		...
		obj.dampenStrength = (float)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
	...
	static int set_onDragStarted(IntPtr L)
	{
		...
		{
			obj.onDragStarted = (UIScrollView.OnDragNotification)LuaScriptMgr.GetNetObject(L, 3, typeof(UIScrollView.OnDragNotification));
		}
		else
		{
	...
	static int set_onDragFinished(IntPtr L)
	{
		...
		if (funcType != LuaTypes.LUA_TFUNCTION)
		{
			obj.onDragFinished = (UIScrollView.OnDragNotification)LuaScriptMgr.GetNetObject(L, 3, typeof(UIScrollView.OnDragNotification));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.ToLuaFunction(L, 3);
	...
	static int set_onMomentumMove(IntPtr L)
	{
		...
		if (funcType != LuaTypes.LUA_TFUNCTION)
		{
			obj.onMomentumMove = (UIScrollView.OnDragNotification)LuaScriptMgr.GetNetObject(L, 3, typeof(UIScrollView.OnDragNotification));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.ToLuaFunction(L, 3);
	...
	static int set_onStoppedMoving(IntPtr L)
	{
		...
		if (funcType != LuaTypes.LUA_TFUNCTION)
		{
			obj.onStoppedMoving = (UIScrollView.OnDragNotification)LuaScriptMgr.GetNetObject(L, 3, typeof(UIScrollView.OnDragNotification));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.ToLuaFunction(L, 3);
	...
	static int set_centerOnChild(IntPtr L)
	{
		...
		obj.centerOnChild = (UICenterOnChild)LuaScriptMgr.GetUnityObject(L, 3, typeof(UICenterOnChild));
		return 0;
	}
