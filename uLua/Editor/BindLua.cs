...
public static class LuaBinding
{
    ...
    static void GenLuaBinder()
    {
        ...
        #region 取消对LuaBinder的switch case, 使用反射代替
        ...
        //    textWriter.Close();
        //}
        #endregion 取消对LuaBinder的switch case, 使用反射代替
    }

    [MenuItem("Lua/Clear LuaBinder File + Wrap Files", false, 13)]
    public static void ClearLuaBinder()
    {
        #region 取消对LuaBinder.cs 的switch case, 使用反射代替, 注掉了
        //StringBuilder sb = new StringBuilder();
        //sb.AppendLine("using System;");
        //sb.AppendLine("using System.Collections.Generic;");
        //sb.AppendLine();
        ...
        //    textWriter.Close();
        //}
        #endregion 取消对LuaBinder.cs 的switch case, 使用反射代替, 注掉了
        if (AppConst.AutoWrapMode) {
            string wrapfile = Application.dataPath + "/Lua/System/Wrap.lua";
    ...
    public static void EncodeLuaFile() {
        ...
        foreach (string f in files) {
            ...
            System.Text.Encoding tEncodeing = GetFileTextType(file);
            string content = string2UTF8(File.ReadAllBytes(file), tEncodeing, System.Text.Encoding.UTF8);
    ...
    /// 转编码
    /// </summary>
    /// <param name="defBytes">源bytes</param>
    /// <param name="srcEncoding">原来编码</param>
    /// <param name="dstEncoding">目标编码</param>
    /// <returns></returns>
    public static string string2UTF8(byte[] defBytes, System.Text.Encoding srcEncoding, System.Text.Encoding dstEncoding)
    {
 
        byte[] utf8Bytes = System.Text.Encoding.Convert(srcEncoding, dstEncoding, defBytes);
        return dstEncoding.GetString(utf8Bytes);
    }
    /// <summary>
    /// 返回文件编码类型
    /// </summary>
    ...
    /// <returns></returns>
    public static System.Text.Encoding GetFileTextType(string FILE_NAME)
    {
        FileStream fs = new FileStream(FILE_NAME, FileMode.Open, FileAccess.Read);
        Encoding r = GetFileTextType(fs);
        fs.Close();
        return r;
    }
    /// <summary>
    ...
    /// <returns></returns>
    private static System.Text.Encoding GetFileTextType(FileStream fs)
    {
