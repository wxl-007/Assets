Shader "Custom/Flash" {
	...
	_FlashColor("Flash Color", Color) = (0.8,0.8,0.8,1)
		_Angle("Flash Angle", Range(0, 180)) = 60
		_Width("Flash Width", Range(0, 1)) = 0.1
		_LoopTime("Loop Time", Float) = 1.5
...
#pragma surface surf Lambert alpha exclude_path:prepass noforwardadd
	...
	void surf(Input IN, inout SurfaceOutput o)
	{
		...
		o.Emission = texCol.rgb + _FlashColor.rgb * brightness;
		o.Alpha = texCol.a;
	}
