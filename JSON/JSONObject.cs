...
public class JSONObject {
	...
	//public void Add(string val) { Add(new JSONObject(val)); }
	...
	public string print(int depth, bool needNull=true) {	//Convert the JSONObject into a string
		if(depth++ > MAX_DEPTH) {
